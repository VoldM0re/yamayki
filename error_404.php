...
<head>
    ...
    <link rel="stylesheet" href="css/pages/error_404.css">
...
<body>
    ...
    <main>
        <section class="error__block-wrapper container">
            <div class="error__block">
                ...
                <p class="error__block-description">“Когда все дороги ведут в никуда - настала пора возвращаться домой” 🌆🔥</p>
            </div>
